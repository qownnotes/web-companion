...
mv dist/bex-chrome/Packaged.qownnotes-web-companion.zip dist/package-chrome.zip || exit 1

# Build the Firefox extension
npm run build-firefox || exit 1
mv dist/bex-firefox/Packaged.qownnotes-web-companion.zip dist/package-firefox.zip || exit 1
