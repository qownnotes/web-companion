  ...
  <q-dialog v-model="dialog">
    <q-card>
      ...
      <q-card-actions align="right">
        <q-btn flat :label="getLocale('Cancel')" tabindex="2" v-close-popup @click="$emit('cancel')" />
        <q-btn flat :label="getLocale('Import')" color="primary" tabindex="1" @click="importBookmarks" />
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
